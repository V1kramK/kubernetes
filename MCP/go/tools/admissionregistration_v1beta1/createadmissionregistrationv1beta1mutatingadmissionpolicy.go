...
func Createadmissionregistrationv1beta1mutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1beta1mutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration_k8s_io_v1beta1_mutatingadmissionpolicies",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1beta1mutatingadmissionpolicyHandler(cfg),
	}
}
