...
func Createadmissionregistrationv1beta1mutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateadmissionregistrationv1beta1mutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration_k8s_io_v1beta1_mutatingadmissionpolicybindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createadmissionregistrationv1beta1mutatingadmissionpolicybindingHandler(cfg),
	}
}
