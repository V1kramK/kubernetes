...
func Deleteadmissionregistrationv1beta1collectionmutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteadmissionregistrationv1beta1collectionmutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration_k8s_io_v1beta1_mutatingadmissionpolicybindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1beta1collectionmutatingadmissionpolicybindingHandler(cfg),
	}
}
