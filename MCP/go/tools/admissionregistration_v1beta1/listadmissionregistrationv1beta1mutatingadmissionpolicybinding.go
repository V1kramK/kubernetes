...
func Listadmissionregistrationv1beta1mutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.Iok8sapiadmissionregistrationv1beta1MutatingAdmissionPolicyBindingList
...
func CreateListadmissionregistrationv1beta1mutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_admissionregistration_k8s_io_v1beta1_mutatingadmissionpolicybindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listadmissionregistrationv1beta1mutatingadmissionpolicybindingHandler(cfg),
	}
}
