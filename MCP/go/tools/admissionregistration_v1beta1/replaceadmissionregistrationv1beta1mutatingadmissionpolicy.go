...
func Replaceadmissionregistrationv1beta1mutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1beta1MutatingAdmissionPolicy
		...
		var result models.Iok8sapiadmissionregistrationv1beta1MutatingAdmissionPolicy
...
func CreateReplaceadmissionregistrationv1beta1mutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration_k8s_io_v1beta1_mutatingadmissionpolicies_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1beta1mutatingadmissionpolicyHandler(cfg),
	}
}
