...
func Replaceadmissionregistrationv1beta1mutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiadmissionregistrationv1beta1MutatingAdmissionPolicyBinding
		...
		var result models.Iok8sapiadmissionregistrationv1beta1MutatingAdmissionPolicyBinding
...
func CreateReplaceadmissionregistrationv1beta1mutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration_k8s_io_v1beta1_mutatingadmissionpolicybindings_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceadmissionregistrationv1beta1mutatingadmissionpolicybindingHandler(cfg),
	}
}
