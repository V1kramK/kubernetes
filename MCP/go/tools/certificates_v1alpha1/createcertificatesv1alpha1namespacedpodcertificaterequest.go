...
func Createcertificatesv1alpha1namespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecertificatesv1alpha1namespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_certificates_k8s_io_v1alpha1_namespaces_namespace_podcertificaterequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createcertificatesv1alpha1namespacedpodcertificaterequestHandler(cfg),
	}
}
