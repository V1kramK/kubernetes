...
func Deletecertificatesv1alpha1collectionnamespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecertificatesv1alpha1collectionnamespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates_k8s_io_v1alpha1_namespaces_namespace_podcertificaterequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletecertificatesv1alpha1collectionnamespacedpodcertificaterequestHandler(cfg),
	}
}
