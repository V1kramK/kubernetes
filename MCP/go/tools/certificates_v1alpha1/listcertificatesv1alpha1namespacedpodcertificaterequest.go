...
func Listcertificatesv1alpha1namespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcertificatesv1alpha1namespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates_k8s_io_v1alpha1_namespaces_namespace_podcertificaterequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listcertificatesv1alpha1namespacedpodcertificaterequestHandler(cfg),
	}
}
