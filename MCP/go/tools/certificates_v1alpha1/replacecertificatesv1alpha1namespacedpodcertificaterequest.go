...
func Replacecertificatesv1alpha1namespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacecertificatesv1alpha1namespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates_k8s_io_v1alpha1_namespaces_namespace_podcertificaterequests_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacecertificatesv1alpha1namespacedpodcertificaterequestHandler(cfg),
	}
}
