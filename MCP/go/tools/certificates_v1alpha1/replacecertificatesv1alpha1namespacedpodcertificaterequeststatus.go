...
func Replacecertificatesv1alpha1namespacedpodcertificaterequeststatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapicertificatesv1alpha1PodCertificateRequest
		...
		var result models.Iok8sapicertificatesv1alpha1PodCertificateRequest
...
func CreateReplacecertificatesv1alpha1namespacedpodcertificaterequeststatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates_k8s_io_v1alpha1_namespaces_namespace_podcertificaterequests_name_status",
		...
		mcp.WithObject("spec", mcp.Required(), mcp.Description("Input parameter: PodCertificateRequestSpec describes the certificate request.  All fields are immutable after creation.")),
		mcp.WithObject("status", mcp.Description("Input parameter: PodCertificateRequestStatus describes the status of the request, and holds the certificate data if the request is issued.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Replacecertificatesv1alpha1namespacedpodcertificaterequeststatusHandler(cfg),
	}
}
