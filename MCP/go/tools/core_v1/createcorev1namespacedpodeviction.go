...
func Createcorev1namespacedpodevictionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapipolicyv1Eviction
		...
		url := fmt.Sprintf("%s/api/v1/namespaces/%s/pods/%s/eviction%s", cfg.BaseURL, queryString)
		...
		var result models.Iok8sapipolicyv1Eviction
