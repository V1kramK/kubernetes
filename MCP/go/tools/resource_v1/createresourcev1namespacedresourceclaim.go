...
func Createresourcev1namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaims",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1namespacedresourceclaimHandler(cfg),
	}
}
