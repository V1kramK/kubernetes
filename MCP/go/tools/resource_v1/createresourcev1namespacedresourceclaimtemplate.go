...
func Createresourcev1namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaimtemplates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1namespacedresourceclaimtemplateHandler(cfg),
	}
}
