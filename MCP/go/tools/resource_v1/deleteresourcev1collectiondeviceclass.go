...
func Deleteresourcev1collectiondeviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourcev1collectiondeviceclassTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1collectiondeviceclassHandler(cfg),
	}
}
