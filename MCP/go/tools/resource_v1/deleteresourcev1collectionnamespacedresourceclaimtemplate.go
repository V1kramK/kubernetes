...
func Deleteresourcev1collectionnamespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourcev1collectionnamespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaimtemplates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1collectionnamespacedresourceclaimtemplateHandler(cfg),
	}
}
