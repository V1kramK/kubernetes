...
func Deleteresourcev1collectionresourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourcev1collectionresourcesliceTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1collectionresourcesliceHandler(cfg),
	}
}
