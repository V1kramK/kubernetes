...
func Listresourcev1namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListresourcev1namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaims",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1namespacedresourceclaimHandler(cfg),
	}
}
