...
func Replaceresourcev1deviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1DeviceClass
		...
		var result models.Iok8sapiresourcev1DeviceClass
...
func CreateReplaceresourcev1deviceclassTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1deviceclassHandler(cfg),
	}
}
