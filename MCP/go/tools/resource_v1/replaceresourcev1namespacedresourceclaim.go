...
func Replaceresourcev1namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceresourcev1namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaims_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1namespacedresourceclaimHandler(cfg),
	}
}
