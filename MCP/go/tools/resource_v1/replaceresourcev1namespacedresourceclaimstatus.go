...
func Replaceresourcev1namespacedresourceclaimstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1ResourceClaim
		...
		var result models.Iok8sapiresourcev1ResourceClaim
...
func CreateReplaceresourcev1namespacedresourceclaimstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaims_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1namespacedresourceclaimstatusHandler(cfg),
	}
}
