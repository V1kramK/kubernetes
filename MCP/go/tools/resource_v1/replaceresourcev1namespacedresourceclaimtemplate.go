...
func Replaceresourcev1namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1ResourceClaimTemplate
		...
		var result models.Iok8sapiresourcev1ResourceClaimTemplate
...
func CreateReplaceresourcev1namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource_k8s_io_v1_namespaces_namespace_resourceclaimtemplates_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1namespacedresourceclaimtemplateHandler(cfg),
	}
}
