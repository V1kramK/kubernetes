...
func Replaceresourcev1resourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapiresourcev1ResourceSlice
		...
		var result models.Iok8sapiresourcev1ResourceSlice
...
func CreateReplaceresourcev1resourcesliceTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1resourcesliceHandler(cfg),
	}
}
