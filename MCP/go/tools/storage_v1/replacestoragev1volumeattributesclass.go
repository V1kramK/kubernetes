...
func Replacestoragev1volumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.Iok8sapistoragev1VolumeAttributesClass
		...
		var result models.Iok8sapistoragev1VolumeAttributesClass
...
func CreateReplacestoragev1volumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacestoragev1volumeattributesclassHandler(cfg),
	}
}
